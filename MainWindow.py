...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.actionAbout_2.triggered.connect(self.DCH)
        self.actionAbout_Model_Traning.triggered.connect(self.MDH)
    ...
    def DCH(self):
        QDesktopServices.openUrl(QUrl('https://en.wikipedia.org/wiki/Data_cleansing'))

    def MDH(self):
        QDesktopServices.openUrl(QUrl('https://en.wikipedia.org/wiki/Machine_learning#Approaches'))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.EditData.setItemText(1, _translate("MainWindow", "Delete"))
        ...
        self.RegressionType.setItemText(3, _translate("MainWindow", "Best Fit Score"))
        ...
        self.ClassificationType.setItemText(6, _translate("MainWindow", "Best Fit Score"))
